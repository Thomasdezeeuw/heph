...
//! async fn requester(mut ctx: actor::Context<!>, mut actor_ref: ActorRef<Add>) -> Result<(), !> {
...
//!
//! /// Sending actor of the RPC.
//! async fn requester(mut ctx: actor::Context<!>, mut actor_ref: ActorRef<Message>) -> Result<(), !> {
