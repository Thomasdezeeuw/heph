...
impl<M, A> NewActor for fn(ctx: LocalContext<M>) -> A
where
    A: Actor,
{
    type Message = M;
...
impl<M, Arg, A> NewActor for fn(ctx: LocalContext<M>, arg: Arg) -> A
where
    A: Actor,
{
    type Message = M;
...
impl<M, Arg1, Arg2, A> NewActor for fn(ctx: LocalContext<M>, arg1: Arg1, arg2: Arg2) -> A
where
    A: Actor,
{
    type Message = M;
