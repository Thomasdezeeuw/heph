...
/// #
/// # fn use_supervisor<S: Supervisor<MyActor, String>>(supervisor: S) { }
...
impl<A, E> Supervisor<A, E> for LogSupervisor
    where A: Actor<Error = E> + Display,
          E: Display,
{
    fn handle_error(&mut self, actor: &mut A, error: E) -> RestartStrategy {
