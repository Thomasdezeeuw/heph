...
pub trait Supervisor<E, A> {
    ...
    ///
    /// [`Actor`]: ../actor/trait.Actor.html
    fn handle_error<'s, 'a>(&'s mut self, actor: &'a mut A, error: E) -> RestartStrategy
        where A: Actor<'a, Error = E>;
}
...
impl<E, A> Supervisor<E, A> for NopSupervisor {
    fn handle_error<'s, 'a>(&'s mut self, _: &'a mut A, _: E) -> RestartStrategy
        where A: Actor<'a, Error = E>
    {
        self.0
    }
