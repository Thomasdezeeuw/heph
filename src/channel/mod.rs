...
//! producer produces values, in that case a [bounded] channel is the way to go.
//!
...
/// Sending half of the channel was dropped, without (more) values being
/// available.
///
...
/// all already send values were received.
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub struct NoValue;
