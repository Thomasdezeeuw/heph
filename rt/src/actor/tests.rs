...
fn actor_name() {
    let tests = &[
        ...
        (
            "core::future::from_generator::GenFuture<functional::functional::timer::triggered_timers_run_actors::deadline_actor<heph_rt::actor::context::ThreadLocal>::{{closure}}>",
            "deadline_actor",
        ),
        (
            "core::future::from_generator::GenFuture<functional::functional::timer::triggered_timers_run_actors::timer_actor<heph_rt::actor::context::ThreadSafe>::{{closure}}>",
            "timer_actor"
        ),
        (
        ...
        (
            "core::future::from_generator::GenFuture<heph_rt::actor::tests::storage::actor::actor::{{closure}}>",
            "storage::actor",
        ),
        // Type implementing `Actor`.
        (
            "heph_rt::net::tcp::server::TcpServer<2_my_ip::conn_supervisor, fn(heph::actor::context::Context<!>, heph::net::tcp::stream::TcpStream, std::net::addr::SocketAddr) -> core::future::from_generator::GenFuture<2_my_ip::conn_actor::{{closure}}>, heph::actor::context::ThreadLocal>",
            "TcpServer",
        ),
        ...
        (
            "TcpServer<2_my_ip::conn_supervisor, fn(heph_rt::actor::context::Context<!>, heph::net::tcp::stream::TcpStream, std::net::addr::SocketAddr) -> core::future::from_generator::GenFuture<2_my_ip::conn_actor::{{closure}}>, heph::actor::context::ThreadLocal>",
            "TcpServer",
        ),
        (
